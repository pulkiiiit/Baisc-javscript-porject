...
const apiKey  = "a8a6914dc825add3d491265dae357e61";// This is getting the api key 

weatherForm.addEventListener("submit" ,  async event => {
    
    event.preventDefault();// this prevent defulat function of the form which is to reload the page
